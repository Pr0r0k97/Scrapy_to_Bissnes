...
def get_page_data(html):
    ...
    for ad in ads:
        ...
        if re.search(r'\bРемонт квартир\b', name) or re.search(r'\bремонт квартир\b', name):
...
def main():
    ...
    for n in numb:
        url = f'http://xmlriver.com/search_yandex/xml?user=6019&key=10e92a3587615ff8137a89723928af6c1c4ef396&query=ремонт%20квартир&page=0&lr={n}'
